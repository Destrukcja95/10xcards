...
describe("flashcards.schema", () => {
  ...
  describe("getFlashcardsQuerySchema", () => {
    ...
    it("should reject limit greater than 100", () => {
      expect(() => getFlashcardsQuerySchema.parse({ limit: "101" })).toThrow("Limit must be between 1 and 100");
    });
  ...
  describe("createFlashcardsSchema", () => {
    ...
    it("should reject empty flashcards array", () => {
      expect(() => createFlashcardsSchema.parse({ flashcards: [] })).toThrow("At least one flashcard is required");
    });
  ...
  describe("flashcardIdParamSchema", () => {
    ...
    it("should reject invalid UUID format", () => {
      expect(() => flashcardIdParamSchema.parse({ id: "not-a-uuid" })).toThrow("Invalid flashcard ID format");
    });
